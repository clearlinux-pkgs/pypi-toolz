...
Source0  : https://files.pythonhosted.org/packages/89/f7/5dcd9647c4fbc7f88f7a53e8ad018bb52ec3aa79bd938ecd6ce9d38cb945/toolz-0.11.0.tar.gz
...
%prep
%setup -q -n toolz-0.11.0
cd %{_builddir}/toolz-0.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600913207
...
cp %{_builddir}/toolz-0.11.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/toolz/78653a88ec8550f2d7425fac201e6fa43be4d1dd
